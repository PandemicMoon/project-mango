/**
 * DHTMLGoodies.com - Seekbar2
 * Author: Alf Magne Kalleland, DHTMLGoodies.com, July 2015
 * License:: https://www.apache.org/licenses/LICENSE-2.0
 */
if(!Seekbar2)var Seekbar2 = {};

Seekbar2.Seekbar2 = function(config){
    config = config || {};

    var props = ["minValue","maxValue","value", "valueListener","negativeColor","positiveColor","needleSize","barSize","onDrag","doneDrag","orientation","aWidth","changeWidth"];
...
$.extend(Seekbar2.Seekbar2.prototype, {
    thumbAlpha : 1,
    renderTo:undefined,
